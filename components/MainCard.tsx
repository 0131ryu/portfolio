...
const MainCard:FunctionComponent<{main: IMain}> = ({
  ...
  return (
    <div className="mb-4 bg-white border border-gray-200 rounded-lg shadow lg:mb-6 lg:w-96 hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
        <a href={deployed_url}>
          <div className='flex'>
